...
public interface Authority {
	...
	//Recibe la id de la votación, crea las claves y las guarda en BD mediante el método RSA.
	public boolean postKeyRSA(String id);
	
	//Recibe la id de la votación y devuelve su clave pública para poder cifrar  mediante el método RSA.
	public String getPublicKeyRSA(String id);
	
	//Recibe la id de la votación y devuelve su clave privada para poder descifrar  mediante el método RSA.
	...
	public byte[] encryptRSA(String idVote, String textToEncypt, int option) throws NoSuchAlgorithmException, IOException;
	...
	//Recibe la id de la votación, crea las claves y las guarda en BD mediante el método DES.
	public void postKeyDES(String id) throws NoSuchAlgorithmException;
	
	//Recibe la id de la votación y devuelve su clave para poder cifrar y descifrar mediante el método DES.
	...
	//Ademas podemos elegir que funcion resumen queremos usar (1 para MD5, 2 para SHA-1).
	public byte[] encryptDES(String id, String text, int option) throws NoSuchAlgorithmException, IOException, InvalidKeyException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException;
